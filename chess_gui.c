...
static const Puzzle gPuzzles[] = {
    ...
    {
        "Scholar's Mate",
        "White to move. The classic mate in 1.",
        {
            "r.bqkbnr",
            "pppp.ppp",
            "..n.....",
    ...
    {
        "Opera Game",
        "White to move. Morphy's famous mate in 1.",
        {
            ".n..kb.r",
            "p....ppp",
            "....q...",
    ...
    {
        "Fool's Mate",
        "Black to move. The fastest possible mate.",
        {
            "rnbqkbnr",
            "pppp.ppp",
            "........",
